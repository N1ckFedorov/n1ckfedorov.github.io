...
$('.c-sticky-contact__action').click(function () {
  $(this).parent('.c-sticky-contact').toggleClass('show')
})

$(document).mouseup(function (e) { 
  var div = $(".c-sticky-contact");
  if (!div.is(e.target)
...
$('.c-apartment-tile__favourite , .c-room-tile__favourite').click(function (event) {
  event.preventDefault();
  $(this).toggleClass('active')
})
$('.c-cookies__close').click(function () {
  $(this).parents('.c-cookies').remove()
})



$('[data-fancyboxes="true"]').fancybox({
  loop: true,
  ...
  btnTpl: {
    ...
    close:
      ...
      '<path fill-rule="evenodd" clip-rule="evenodd" d="M13.7214 0.278417C13.3502 -0.0928059 12.7483 -0.0928058 12.3771 0.278418L6.99999 5.65562L1.62286 0.278418C1.25164 -0.0928058 0.649773 -0.0928059 0.278555 0.278417C-0.092664 0.649641 -0.0926637 1.25151 0.278555 1.62274L5.65569 6.99994L0.278414 12.3773C-0.0928046 12.7485 -0.0928048 13.3504 0.278414 13.7216C0.649633 14.0928 1.2515 14.0928 1.62272 13.7216L6.99999 8.34426L12.3773 13.7216C12.7485 14.0928 13.3504 14.0928 13.7216 13.7216C14.0928 13.3504 14.0928 12.7485 13.7216 12.3773L8.34429 6.99994L13.7214 1.62274C14.0926 1.25151 14.0926 0.649641 13.7214 0.278417Z" fill="white"/>' +
      "</svg>" +
      "</button>",
    arrowLeft:
      '<button data-fancybox-prev class="fancybox-button fancybox-button--arrow_left" title="{{PREV}}">' +
      '<svg viewBox="0 0 8 14">' +
      '<path d="M2.828 7.00023L7.778 11.9502L6.364 13.3642L0 7.00023L6.364 0.63623L7.778 2.05023L2.828 7.00023Z" fill="#999999"/>' +
      "</svg>" +
      "</button>",
    ...
    arrowRight:
      ...
      '<svg viewBox="0 0 8 14">' +
      '<path d="M5.172 6.99977L0.222002 2.04977L1.636 0.635766L8 6.99977L1.636 13.3638L0.222001 11.9498L5.172 6.99977Z" fill="#999999"/>' +
      "</svg>" +
      "</button>"
  },
});
